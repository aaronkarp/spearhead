...
namespace Spearhead
{
    ...
    /// </summary>
    class LeftMissileDoor : Component
    {
        #region Fields
        ...
        public LeftMissileDoor(Boss boss, Vector2 origin, Vector2 offset, ContentManager content, int health, int value, bool mirrored, bool collidable, bool critical)
            : base(boss, origin, offset, "Images/level-5-boss-wing-left-missile-doors-spritesheet", content, health, value, mirrored, collidable, critical)
        {
            Texture = content.Load<Texture2D>("Images/level-5-boss-wing-left-missile-doors-spritesheet");
        ...
        public override void UpdateComponent(GameTime gameTime, Level5Boss boss, string leftDoorStatus, string rightDoorStatus)
        {
            ...
            if (!Destroyed)
            {
                ...
                {
                    Status = "Opening";
                    boss.LeftMissiles.Damageable = true;
                ...
                if (Math.Abs(Travel) >= 9)
                {
                    ...
                    {
                        Status = "Closed";
                        boss.LeftMissiles.Damageable = false;
                        Travel = 0;
                    }
                }
        ...
        {
            startPosition += new Vector2(4, 10);
