...
{
    /// <summary>
    /// This class creates the right missile bay component
    /// </summary>
    class RightMissiles : Component
    {
        #region Fields
        ...
        public RightMissiles(Boss boss, Vector2 origin, Vector2 offset, ContentManager content, int health, int value, bool mirrored, bool collidable, bool critical)
            : base(boss, origin, offset, "images/level-5-boss-wing-right-missiles-spritesheet", content, health, value, mirrored, collidable, critical)
        {
            Texture = content.Load<Texture2D>("Images/level-5-boss-wing-right-missiles-spritesheet");
        ...
        public override void UpdateComponent(GameTime gameTime, Level5Boss boss, string leftDoorStatus, string rightDoorStatus)
        {
            ...
            if (rightDoorStatus == "Firing" || rightDoorStatus == "Closing" || Destroyed)
            {
            ...
            if (Destroyed)
                boss.RightMissileDoor.Health = 0;
