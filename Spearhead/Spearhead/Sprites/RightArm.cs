...
{
    /// <summary>
    /// This class creates the right arm of the Pincer Wing boss
    /// </summary>
    class RightArm : Component
    {
        #region Fields
        ...
        public RightArm(Boss boss, Vector2 origin, Vector2 offset, ContentManager content, int health, int value, bool mirrored, bool collidable, bool critical)
            : base(boss, origin, offset, "Images/level-2-boss-right-arm-spritesheet", content, health, value, mirrored, collidable, critical)
        {
            FrameSize = new Vector2(84, 272);
            Texture = content.Load<Texture2D>("Images/level-2-boss-right-arm-spritesheet");
            Destroyed = false;
