...
{
    /// <summary>
    /// This class creates the left thruster pod of the Rail Wing boss
    /// </summary>
    class LeftThrusterPod : Component
    {
        #region Fields
        ...
        public LeftThrusterPod(Boss boss, Vector2 origin, Vector2 offset, ContentManager content, int health, int value, bool mirrored, bool collidable, bool critical)
            : base(boss, origin, offset, "Images/level-5-boss-ship-left-pod-spritesheet", content, health, value, mirrored, collidable, critical)
        {
            Texture = content.Load<Texture2D>("Images/level-5-boss-ship-left-pod-spritesheet");
        ...
        public override void UpdateComponent(GameTime gameTime, Level5Boss boss, string leftDoorStatus, string rightDoorStatus)
        {
            ...
            HitArea = new Rectangle((int)Position.X, (int)Position.Y, 48, 200);
