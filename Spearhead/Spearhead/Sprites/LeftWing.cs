...
namespace Spearhead
{
    ...
    class LeftWing : Component
    {
        ...
        public LeftWing(Boss boss, Vector2 origin, Vector2 offset, ContentManager content, int health, int value, bool mirrored, bool collidable, bool critical)
            : base(boss, origin, offset, "Images/level-5-boss-ship-left-wing-spritesheet", content, health, value, mirrored, collidable, critical)
        {
            Texture = content.Load<Texture2D>("Images/level-5-boss-ship-left-wing-spritesheet");
            ...
            firing = true;
            projectileTexture = "Images/DualGunRoundSmallA";
            gunOffset = new Vector2(20, 104);
        ...
        public override void UpdateComponent(GameTime gameTime, Level5Boss boss, string leftDoorStatus, string rightDoorStatus)
        {
            ...
            HitArea = new Rectangle((int)Position.X + 18, (int)Position.Y, 10, 104);
