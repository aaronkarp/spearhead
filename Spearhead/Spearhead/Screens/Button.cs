...
namespace Spearhead
{
    ...
    class Button
    {
        ...
        /// </summary>
        public Color TextShadowColor = Color.CornflowerBlue;
        ...
        public void Draw(GameScreen screen)
        {
            ...
            SpriteFont titleFont = screen.ScreenManager.ScoreFont;
            SpriteFont buttonFont = screen.ScreenManager.ButtonFont;
            ...
            // Draw the text twice to provide a drop-shadow
            spriteBatch.DrawString(buttonFont, Text, new Vector2(textPosition.X + 2, textPosition.Y + 2), TextShadowColor);
            spriteBatch.DrawString(buttonFont, Text, textPosition, TextColor);
        }
    }
}
