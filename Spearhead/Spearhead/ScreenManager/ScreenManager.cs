...
namespace Spearhead
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        bool extraLife10000 = false;
        bool extraLife20000 = false;
        bool extraLife40000 = false;
        bool extraLife80000 = false;
        bool extraLife160000 = false;
        bool extraLife320000 = false;
        bool extraLife640000 = false;

        bool traceEnabled;

        bool isTrialMode = true;
        ...
        // The following properties store powerup information
        // in order to carry powerups between levels and 
        // when starting from a saved game

        // This stores the main weapon powerup
        ...
        // This stores the secondary weapon powerup
        public string CurrentSecondary
        {
            get { return currentSecondary; }
            set { currentSecondary = value; }
        }

        string currentSecondary = "None";
        ...
        string currentShield = "None";

        // This stores the shield's current health
        public int CurrentShieldStrength
        {
            get { return currentShieldStrength; }
            set { currentShieldStrength = value; }
        }

        int currentShieldStrength = 0;
        ...
        /// <summary>
        /// A small font shared by all the screens. This saves
        ...
        /// <summary>
        /// A large font shared by all the screens. This saves
        /// each screen having to bother loading their own local copy.
        /// </summary>
        ...
        /// <summary>
        /// Provides an easily accessible global game time.
        /// </summary>
        public TimeSpan GlobalGameTime
        {
            get { return globalGameTime; }
            set { globalGameTime = value; }
        }

        TimeSpan globalGameTime;

        /// <summary>
        /// Keeps track of the time spent playing (not paused or in menus)
        /// </summary>
        ...
        protected override void LoadContent()
        {
            ...
            buttonFont = content.Load<SpriteFont>("Fonts/squarefuture");
            scoreFont = content.Load<SpriteFont>("Fonts/squarefuture_small");
            blankTexture = content.Load<Texture2D>("Images/pixel");
        ...
        {
            // Copy the Total Game Time to GlobalGameTime
            GlobalGameTime = gameTime.TotalGameTime;

            // If the game isn't paused, update ActiveTime
            if (!IsPaused)
            {
            ...
            // Award Extra Lives where appropriate
            if (PlayerScore >= 10000 && extraLife10000 == false)
            {
                PlayerLives++;
                extraLife10000 = true;
            }

            if (PlayerScore >= 20000 && extraLife20000 == false)
            {
                PlayerLives++;
                extraLife20000 = true;
            }

            if (PlayerScore >= 40000 && extraLife40000 == false)
            {
                PlayerLives++;
                extraLife40000 = true;
            }

            if (PlayerScore >= 80000 && extraLife80000 == false)
            {
                PlayerLives++;
                extraLife80000 = true;
            }

            if (PlayerScore >= 160000 && extraLife160000 == false)
            {
                PlayerLives++;
                extraLife160000 = true;
            }

            if (PlayerScore >= 320000 && extraLife320000 == false)
            {
                PlayerLives++;
                extraLife320000 = true;
            }

            if (PlayerScore >= 640000 && extraLife640000 == false)
            {
                PlayerLives++;
                extraLife640000 = true;
            }
