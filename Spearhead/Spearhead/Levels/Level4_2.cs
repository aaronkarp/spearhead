...
{
    /// <summary>
    /// This screen implements the game's eleventh level
    /// </summary>
    class Level4_2 : GameScreen
    {
        #region Fields
        ...
        ScrollingBackground asteroidLevel1;
        ScrollingBackground asteroidLevel2;
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            if (!instancePreserved)
            {
                ...
                asteroidLevel1 = new ScrollingBackground();
                asteroidLevel2 = new ScrollingBackground();
                ...
                asteroidLevel1.Initialize(content, ScreenManager.SpriteBatch, "Images/level-4-background-5", 800, 10);
                asteroidLevel2.Initialize(content, ScreenManager.SpriteBatch, "Images/level-4-background-6", 800, 14);
                backgrounds.Add(starLevel1);
                backgrounds.Add(starLevel2);
                backgrounds.Add(starLevel3);
                backgrounds.Add(maskLevel);
                backgrounds.Add(asteroidLevel1);
                backgrounds.Add(asteroidLevel2);
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Wedge(content, gameTime, "Aphid", 1500, 1f, "Burst");
            ...
            {
                Wave2 = new Wedge(content, gameTime, "Rhino", 1500, 1f, "Burst");
                formations.Add(Wave2);
                currentWave = 2;
            }

            if (ActiveTimer >= 21.5 && Wave3 == null)
            {
                Wave3 = new Wedge(content, gameTime, "Hawk", 1500, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 34.5 && Wave4 == null)
            {
                Wave4 = new SweepDown(content, gameTime, "Rhino", 1500, 1f, "Burst");
            ...
            if (ActiveTimer >= 47 && Wave5 == null)
            {
                Wave5 = new SweepUp(content, gameTime, "Hawk", 1500, 1f, "Burst");
                formations.Add(Wave5);
                currentWave = 5;
            }

            if (ActiveTimer >= 60.5 && Wave6 == null)
            {
                Wave6 = new SweepUp(content, gameTime, "Rhino", 1500, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (ActiveTimer >= 74 && Wave7 == null)
            {
                Wave7 = new Wedge(content, gameTime, "Hawk", 1500, 1f, "Burst");
                formations.Add(Wave7);
                currentWave = 7;
            }

            if (ActiveTimer >= 85.5 && Wave8 == null)
            {
                Wave8 = new Zigzag(content, gameTime, "Rhino", 1500, 1f, "Burst");
                formations.Add(Wave8);
                currentWave = 8;
            }

            if (Wave8 != null && Wave8.CompleteWave && Wave7 != null && Wave7.CompleteWave && Wave5 != null && Wave6.CompleteWave && Wave6 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
