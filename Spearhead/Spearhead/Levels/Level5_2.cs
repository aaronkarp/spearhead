...
{
    /// <summary>
    /// This screen implements the game's fourteenth level
    /// </summary>
    class Level5_2 : GameScreen
    {
        #region Fields
        ...
        ScrollingBackground shipLevel1;
        ScrollingBackground shipLevel2;
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            if (!instancePreserved)
            {
                ...
                shipLevel1 = new ScrollingBackground();
                shipLevel2 = new ScrollingBackground();
                ...
                shipLevel1.Initialize(content, ScreenManager.SpriteBatch, "Images/level-5-background-5", 800, 10);
                shipLevel2.Initialize(content, ScreenManager.SpriteBatch, "Images/level-5-background-6", 800, 14);
                backgrounds.Add(starLevel1);
                backgrounds.Add(starLevel2);
                backgrounds.Add(starLevel3);
                backgrounds.Add(maskLevel);
                backgrounds.Add(shipLevel1);
                backgrounds.Add(shipLevel2);
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Wedge(content, gameTime, "Aphid", 2000, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 10.5 && Carrier == null)
            {
            ...
            if (ActiveTimer >= 40.5 && Carrier2 == null)
            {
                Vector2 startPosition = new Vector2(0, -36);
            ...
            if (ActiveTimer >= 80.5 && Carrier == null)
            {
                Vector2 startPosition = new Vector2(0, -36);
            ...
            if (ActiveTimer >= 10 && Wave2 == null)
            {
                Wave2 = new Wedge(content, gameTime, "Aphid", 2000, 1f, "Burst");
                formations.Add(Wave2);
                currentWave = 2;
            }

            if (ActiveTimer >= 20.5 && Wave3 == null)
            {
                Wave3 = new Wedge(content, gameTime, "Rhino", 2000, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 30.5 && Wave4 == null)
            {
                Wave4 = new Wedge(content, gameTime, "Rhino", 2000, 1f, "Burst");
                formations.Add(Wave4);
                currentWave = 4;
            }

            if (ActiveTimer >= 40 && Wave5 == null)
            {
                Wave5 = new Wedge(content, gameTime, "Hawk", 2000, 1f, "Burst");
                formations.Add(Wave5);
                currentWave = 5;
            }

            if (ActiveTimer >= 51.5 && Wave6 == null)
            {
                Wave6 = new Wedge(content, gameTime, "Hawk", 2000, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (ActiveTimer >= 64.5 && Wave7 == null)
            {
                Wave7 = new SweepUp(content, gameTime, "Rhino", 2000, 1f, "Burst");
                formations.Add(Wave7);
                currentWave = 7;
            }

            if (ActiveTimer >= 79.5 && Wave8 == null)
            {
                Wave8 = new SweepHold(content, gameTime, "Aphid", 2000, 1f, "Burst");
                formations.Add(Wave8);
                currentWave = 8;
            }

            if (ActiveTimer >= 92.5 && Wave9 == null)
            {
                Wave9 = new SweepDown(content, gameTime, "Hawk", 2000, 1f, "Burst");
                formations.Add(Wave9);
                currentWave = 9;
            }

            if (ActiveTimer >= 105.5 && Wave10 == null)
            {
                Wave10 = new Wedge(content, gameTime, "Hawk", 2000, 1f, "Burst");
                formations.Add(Wave10);
                currentWave = 10;
            }

            if (Wave10 != null && Wave10.CompleteWave && Wave9 != null && Wave9.CompleteWave && Wave8 != null && Wave8.CompleteWave && Wave7 != null && Wave7.CompleteWave && Wave6 != null && Wave6.CompleteWave && Wave5 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
