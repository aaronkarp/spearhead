...
{
    /// <summary>
    /// This screen implements the game's tenth level
    /// </summary>
    class Level4_1 : GameScreen
    {
        #region Fields
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Wedge(content, gameTime, "Rhino", 1200, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 18.5 && Carrier == null)
            {
            ...
            {
                Wave2 = new Zigzag(content, gameTime, "Aphid", 1200, 1f, "Burst");
            ...
            {
                Wave3 = new SweepUp(content, gameTime, "Hawk", 1200, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 35.5 && Wave4 == null)
            {
                Wave4 = new Wedge(content, gameTime, "Rhino", 1200, 1f, "Burst");
            ...
            {
                Wave5 = new Zigzag(content, gameTime, "Hawk", 1200, 1f, "Burst");
                formations.Add(Wave5);
                currentWave = 5;
            }

            if (ActiveTimer >= 42.5 && Wave6 == null)
            {
                Wave6 = new Zigzag(content, gameTime, "Rhino", 1200, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (ActiveTimer >= 55 && Wave7 == null)
            {
                Wave7 = new Zigzag(content, gameTime, "Hawk", 1200, 1f, "Burst");
                formations.Add(Wave7);
                currentWave = 7;
            }

            if (Wave7 != null && Wave7.CompleteWave && Wave6 != null && Wave6.CompleteWave && Wave5 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
