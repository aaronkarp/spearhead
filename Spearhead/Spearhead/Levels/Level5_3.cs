...
{
    /// <summary>
    /// This screen implements the game's final level, the fifth boss fight
    /// </summary>
    class Level5_3 : GameScreen
    {
        #region Fields
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                if (ActiveTimer >= 15.0 && Carrier2 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                ...
                if (ActiveTimer >= 25.0 && Carrier3 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                ...
                if (ActiveTimer >= 33.0 && Carrier4 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                    Carrier4 = new PowerupCarrier(startPosition, content, "Powerup");
                    carriers.Add(Carrier4);
                }

                if (ActiveTimer >= 3.0 && Boss == null)
                {
                    Boss = new Level5Boss(new Vector2(12, -250), content, 5000);
                }
                ...
                if (completeScreen != null)
                {
                    ...
                    {
                        LoadingScreen.Load(ScreenManager, true, PlayerIndex.One, new Ending());
                        ScreenManager.RemoveScreen(this);
                    }
                }
            }
