...
{
    /// <summary>
    /// This screen implements the game's sixth level, the second boss fight
    /// </summary>
    class Level2_3 : GameScreen
    {
        #region Fields
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                {
                    Boss = new Level2Boss(new Vector2(117, -300), content, 8000);
                }
        ...
        private void UpdateCollision()
        {
            ...
            if (!playerShip.Dead)
            {
                ...
                if (Boss != null)
                {
                    ...
                    Level2Boss l2Boss = (Level2Boss)Boss;
                    if (l2Boss.electricalField != null)
                    {
                        rectangle2 = new Rectangle((int)l2Boss.electricalField.ElectricalFieldAnimation.animPosition.X, (int)l2Boss.electricalField.ElectricalFieldAnimation.animPosition.Y, (int)l2Boss.electricalField.ElectricalFieldAnimation.FrameWidth, (int)l2Boss.electricalField.ElectricalFieldAnimation.FrameHeight);
                        ...
                        if (rectangle1.Intersects(rectangle2))
                        {
                            ...
                            {
                                if (!playerShip.Invincible)
                                    playerShip.Health -= l2Boss.electricalField.Damage;
                            }
                            ...
                            if (l2Boss.electricalField.ImpactType == "large")
                            {
                                frameWidth = 16;
                                frameHeight = 16;
                                frameCount = 4;
                            ...
                            if (!playerShip.Invincible)
                                AddImpact(new Vector2((playerShip.Position.X - ((playerShip.Width - impactTexture.Width) / 2)), playerShip.Position.Y + 20), impactTexture, frameWidth, frameHeight, frameCount, frameTime);
                        }
                    }
                }
