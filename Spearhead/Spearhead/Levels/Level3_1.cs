...
{
    /// <summary>
    /// This screen implements the game's seventh level
    /// </summary>
    class Level3_1 : GameScreen
    {
        #region Fields
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Zigzag(content, gameTime, "Rhino", 800, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 3.5 && Carrier == null)
            {
            ...
            if (ActiveTimer >= 12 && Wave2 == null)
            {
                Wave2 = new Zigzag(content, gameTime, "Aphid", 800, 1f, "Burst");
                formations.Add(Wave2);
                currentWave = 2;
            }

            if (ActiveTimer >= 24.5 && Wave3 == null)
            {
            ...
            if (ActiveTimer >= 31.5 && Carrier2 == null)
            {
                Vector2 startPosition = new Vector2(0, -36);
            ...
            if (ActiveTimer >= 38.5 && Wave4 == null)
            {
                Wave4 = new Wedge(content, gameTime, "Rhino", 800, 1f, "Burst");
                formations.Add(Wave4);
                currentWave = 4;
            }

            if (ActiveTimer >= 50 && Wave5 == null)
            {
            ...
            if (ActiveTimer >= 66.5 && Wave6 == null)
            {
                Wave6 = new SweepHold(content, gameTime, "Aphid", 1000, 1f, "Burst");
