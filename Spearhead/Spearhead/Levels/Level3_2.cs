...
{
    /// <summary>
    /// This screen implements the game's eighth level
    /// </summary>
    class Level3_2 : GameScreen
    {
        #region Fields
        ...
        {
            if (ActiveTimer >= 4.0 && Wave1 == null)
            {
                Wave1 = new Zigzag(content, gameTime, "Hawk", 1000, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 32.5 && Carrier == null)
            {
            ...
            {
                Wave2 = new Zigzag(content, gameTime, "Aphid", 1000, 1f, "Burst");
                formations.Add(Wave2);
                currentWave = 2;
            }

            if (ActiveTimer >= 18.5 && Wave3 == null)
            {
                Wave3 = new SweepDown(content, gameTime, "Rhino", 1000, 1f, "Burst");
            ...
            {
                Wave4 = new Wedge(content, gameTime, "Aphid", 1000, 1f, "Burst");
                formations.Add(Wave4);
                currentWave = 4;
            }

            if (ActiveTimer >= 42 && Wave5 == null)
            {
            ...
            if (ActiveTimer >= 52.5 && Wave6 == null)
            {
                Wave6 = new Wedge(content, gameTime, "Hawk", 1000, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (ActiveTimer >= 60 && Wave7 == null)
            {
                Wave7 = new SweepDown(content, gameTime, "Hawk", 1000, 1f, "Burst");
