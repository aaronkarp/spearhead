...
{
    /// <summary>
    /// This screen implements the game's fourth level
    /// </summary>
    class Level2_1 : GameScreen
    {
        #region Fields

        ContentManager content;
        GraphicsDevice graphics;
        ScrollingBackground cloudLevel1;
        ScrollingBackground cloudLevel2;
        ScrollingBackground groundLevel;
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            if (!instancePreserved)
            {
                ...
                cloudLevel1 = new ScrollingBackground();
                cloudLevel2 = new ScrollingBackground();
                groundLevel = new ScrollingBackground();
                zeroLevel = new ScrollingBackground();
                cloudLevel1.Initialize(content, ScreenManager.SpriteBatch, "Images/level-2-background-3", 800, 10);
                cloudLevel2.Initialize(content, ScreenManager.SpriteBatch, "Images/level-2-background-2", 800, 4);
                groundLevel.Initialize(content, ScreenManager.SpriteBatch, "Images/level-2-background-1", 800, 1);
                zeroLevel.Initialize(content, ScreenManager.SpriteBatch, "Images/level-2-background-0", 800, 0);
                backgrounds.Add(zeroLevel);
                backgrounds.Add(groundLevel);
                backgrounds.Add(cloudLevel1);
                backgrounds.Add(cloudLevel2);
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Zigzag(content, gameTime, "Rhino", 500, 1f, "Burst");
            ...
            {
                Wave2 = new Zigzag(content, gameTime, "Aphid", 600, 1f, "Burst");
            ...
            {
                Wave3 = new SweepDown(content, gameTime, "Hawk", 700, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 31.5 && Wave4 == null)
            {
            ...
            {
                Wave5 = new SweepUp(content, gameTime, "Hawk", 1000, 1f, "Burst");
                formations.Add(Wave5);
                currentWave = 5;
            }

            if (ActiveTimer >= 44 && Wave6 == null)
            {
                Wave6 = new Wedge(content, gameTime, "Rhino", 1000, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (Wave6 != null && Wave6.CompleteWave && Wave5 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
