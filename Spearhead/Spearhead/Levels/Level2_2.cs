...
{
    /// <summary>
    /// This screen implements the game's fifth level
    /// </summary>
    class Level2_2 : GameScreen
    {
        #region Fields
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Wedge(content, gameTime, "Hawk", 800, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 15.5 && Carrier == null)
            {
            ...
            {
                Wave2 = new Zigzag(content, gameTime, "Rhino", 800, 1f, "Burst");
            ...
            {
                Wave3 = new SweepDown(content, gameTime, "Hawk", 800, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 32.5 && Wave4 == null)
            {
                Wave4 = new Wedge(content, gameTime, "Rhino", 1000, 1f, "Burst");
                formations.Add(Wave4);
                currentWave = 4;
            }

            if (ActiveTimer >= 44 && Wave5 == null)
            {
            ...
            if (ActiveTimer >= 55 && Wave6 == null)
            {
                Wave6 = new Wedge(content, gameTime, "Aphid", 1000, 1f, "Burst");
