...
{
    /// <summary>
    /// This screen implements the game's thirteenth level
    /// </summary>
    class Level5_1 : GameScreen
    {
        #region Fields
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new SweepHold(content, gameTime, "Aphid", 1750, 1f, "Burst");
                formations.Add(Wave1);
                currentWave = 1;
            }

            if (ActiveTimer >= 6.5 && Carrier == null)
            {
            ...
            if (ActiveTimer >= 13 && Wave2 == null)
            {
                Wave2 = new Zigzag(content, gameTime, "Rhino", 1750, 1f, "Burst");
                formations.Add(Wave2);
                currentWave = 2;
            }

            if (ActiveTimer >= 23 && Wave3 == null)
            {
                Wave3 = new Wedge(content, gameTime, "Hawk", 1750, 1f, "Burst");
                formations.Add(Wave3);
                currentWave = 3;
            }

            if (ActiveTimer >= 25.5 && Wave4 == null)
            {
                Wave4 = new Wedge(content, gameTime, "Aphid", 700, 1f, "Burst");
                formations.Add(Wave4);
                currentWave = 4;
            }

            if (ActiveTimer >= 30 && Carrier2 == null)
            {
                Vector2 startPosition = new Vector2(0, -36);
            ...
            if (ActiveTimer >= 51.5 && Carrier3 == null)
            {
                Vector2 startPosition = new Vector2(0, -36);
            ...
            if (ActiveTimer >= 32 && Wave5 == null)
            {
                Wave5 = new SweepUp(content, gameTime, "Hawk", 1750, 1f, "Burst");
                formations.Add(Wave5);
                currentWave = 5;
            }

            if (ActiveTimer >= 45 && Wave6 == null)
            {
                Wave6 = new SweepHold(content, gameTime, "Rhino", 1750, 1f, "Burst");
                formations.Add(Wave6);
                currentWave = 6;
            }

            if (ActiveTimer >= 62.5 && Wave7 == null)
            {
                Wave7 = new SweepDown(content, gameTime, "Aphid", 1750, 1f, "Burst");
                formations.Add(Wave7);
                currentWave = 7;
            }

            if (ActiveTimer >= 75.5 && Wave8 == null)
            {
                Wave8 = new SweepHold(content, gameTime, "Hawk", 1750, 1f, "Burst");
                formations.Add(Wave8);
                currentWave = 8;
            }

            if (Wave8 != null && Wave8.CompleteWave && Wave7 != null && Wave7.CompleteWave && Wave6 != null && Wave6.CompleteWave && Wave5 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
