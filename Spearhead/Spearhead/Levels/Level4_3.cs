...
{
    /// <summary>
    /// This screen implements the game's twelfth level, the fourth boss fight
    /// </summary>
    class Level4_3 : GameScreen
    {
        #region Fields
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                if (ActiveTimer >= 12.0 && Carrier2 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                ...
                if (ActiveTimer >= 22.0 && Carrier3 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                ...
                if (ActiveTimer >= 32.0 && Carrier4 == null)
                {
                    Vector2 startPosition = new Vector2(0, -36);
                ...
                {
                    Boss = new Level4Boss(new Vector2(96, -350), content, 5000);
                }
