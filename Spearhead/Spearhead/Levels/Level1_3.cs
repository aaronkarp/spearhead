...
{
    /// <summary>
    /// This screen implements the game's third level, the first boss fight
    /// </summary>
    class Level1_3 : GameScreen
    {
        #region Fields
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (IsActive)
            {
                ...
                {
                    Boss = new Level1Boss(new Vector2(85, -300), content, 5000);
                }
                ...
                if (completeScreen != null)
                {
                    ...
                    if (completeScreen.Finished)
                    {
                        if (Guide.IsTrialMode)
                            LoadingScreen.Load(ScreenManager, true, PlayerIndex.One, new TrialModeScreen());
                        else
