...
{
    /// <summary>
    /// This screen implements the game's second level
    /// </summary>
    class Level1_2 : GameScreen
    {
        #region Fields
        ...
        public void UpdateFormations(GameTime gameTime)
        {
            ...
            {
                Wave1 = new Zigzag(content, gameTime, "Hawk", 500, 1f, "Burst");
            ...
            {
                Wave3 = new SweepDown(content, gameTime, "Rhino", 700, 1f, "Burst");
            ...
            if (Wave5 != null && Wave5.CompleteWave && Wave4 != null && Wave4.CompleteWave && Wave3 != null && Wave3.CompleteWave && Wave2 != null && Wave2.CompleteWave && Wave1 != null && Wave1.CompleteWave)
            {
